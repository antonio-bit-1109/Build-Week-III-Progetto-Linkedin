                ...
                <Navbar expand="lg" className="bg-body-tertiary position-fixed top-0 index">
                    <Container>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="me-auto d-md-none">
                                <NavLink className="nav-link" to={"/"}>
                                    <div className="d-flex align-items-center p-1 text-secondary">
                                        <HouseDoorFill className="fs-4" />
                                        <p className="m-0">Home</p>
                                    </div>
                                </NavLink>

                                <NavLink className={"text-decoration-none"} to={"/praticaModale"}>
                                    <div className="d-flex  text p-1 text-secondary">
                                        <PeopleFill className="fs-4" />
                                        <p className="m-0 text-decoration-none">Rete</p>
                                    </div>
                                </NavLink>
                        ...
                        <div className="d-none d-md-flex justify-content-sm-center justify-content-end gap-4 flex-grow-1">
                            ...
                            <NavLink className="text-decoration-none" to={"/praticaModale"}>
                                <div className="d-flex align-items-center flex-column p-1 text-secondary">
                                    <PeopleFill className="fs-4" />
                                    <p className="m-0 text-decoration-none">Rete</p>
                                </div>
                            </NavLink>
                                    ...
                                    <div className="d-flex flex-column mb-2">
                                        <div className="d-flex">
                                            ...
                                            <div className="d-flex flex-column">
                                                {dataFetchProfilo ? (
                                                    <h6 className="m-1">
                                                        {dataFetchProfilo.name + " " + dataFetchProfilo.surname}
                                                    </h6>
                                                ) : (
